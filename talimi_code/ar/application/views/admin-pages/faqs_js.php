    ...
    $(document).ready(function() {
        ...
        function getFaqData() {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url(); ?>ar/get-faqs",
                ...
                error: function(response) {
                    ...
                    if (response.status == "401") {
                        ...
                        window.location = "<?php echo base_url('ar/u-login'); ?>";
        ...
        $(document).on("click", ".fa-edit", function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url(); ?>ar/get-this-faq",
        ...
        $.validator.setDefaults({
            ...
            submitHandler: function() {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>ar/create-update-faq",
