<script>
    ...
    window.onload = function translate() {
        if (lang == 1) {
            ...
            document.getElementsByClassName('hafilaty_pic')[0].src = "<?php echo base_url('ar/assets/images') ?>/hafilaty_ar.jpeg";
            document.getElementsByClassName('schoooly_pic')[0].src = "<?php echo base_url('ar/assets/images') ?>/schoooly_ar.jpeg";
            document.getElementsByClassName('ht_pic')[0].src = "<?php echo base_url('ar/assets/images') ?>/ht_ar.jpeg";
            document.getElementsByClassName('hafilaty_pic')[1].src = "<?php echo base_url('ar/assets/images') ?>/hafilaty_ar.jpeg";
            document.getElementsByClassName('schoooly_pic')[1].src = "<?php echo base_url('ar/assets/images') ?>/schoooly_ar.jpeg";
            document.getElementsByClassName('ht_pic')[1].src = "<?php echo base_url('ar/assets/images') ?>/ht_ar.jpeg";
