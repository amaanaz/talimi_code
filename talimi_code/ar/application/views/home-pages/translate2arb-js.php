<script>
    ...
    window.onload = function translate() {
        if (lang == 1) {
            ...
            // console.log("DOH,: ", document.location.href);
            ...
            if (page == "contact_us") {
                ...
                // document.getElementById('p2').innerText = "<p> ترخيص </p>";
                document.getElementById('p2').innerText = ' منح الترخيص. إذا حصلت على البرنامج من "مالك تعليمي" أو أحد المرخص لهم ، ورهناً بامتثالك لشروط هذه الاتفاقية ، بما في ذلك القيود (إن وجدت) الواردة في القسم 3 ، يمنحك "مالك تعليمي" حقًا محدودًا -غير حصري وغير مجير للغير غير قابل للتحويل وغير قابل للترخيص من الباطن وغير قابل لاسترداد رسومه وقابل لإلغاء الرخصة -  لاستخدام البرنامج بطريقة تتفق مع تصميمه والغرض المقصود منه. بالنقر فوق الزر "شراء الآن" ، ترسل إلينا عرضًا ملزمًا لإبرام اتفاقية الشراء هذه مع "مالك تعليمي" بخصوص البرنامج.\n\n استخدام عام. يجوز لك تثبيت نسخ متعددة من البرنامج واستخدامها على جهاز الكمبيوتر أو الكمبيوتر المحمول أو الجهاز اللوحي أو الهاتف الذكي.\n\n استخدام الخادم. تسمح لك هذه الاتفاقية بتثبيت البرنامج أو استخدامه على خادم افتراضي ، أو خادم محلي.\n\n التوزيع. لا يمنحك هذا الترخيص الحق في ترخيص البرنامج أو توزيعه.\n\n تكامل البرمجيات. قد يتم توفير البرنامج لك كجزء من تكامل البرامج ويخضع استخدامك لتكامل البرامج لأي شروط إضافية قابلة للتطبيق.\n\nحدود التوفر. قد لا يتوفر البرنامج بجميع اللغات أو للمقيمين من جميع البلدان.';
                ...
                document.getElementById('p20').innerHTML = '<p>  تستخدم برامج تعليمي ملفات تعريف الارتباط وتقنيات التتبع المماثلة لتتبع النشاط على الخدمة وتخزين معلومات معينة. تقنيات التتبع المستخدمة هي إشارات وعلامات ونصوص لجمع المعلومات وتتبعها ولتحسين الخدمة المقدمة وتحليلها. قد تشمل التقنيات التي تستخدمها برامج تعليمي ما يلي: </p><p>ملفات تعريف الارتباط أو ملفات تعريف الارتباط للمتصفح. ملف تعريف الارتباط هو ملف صغير يوضع على جهازك. يمكنك توجيه متصفحك لرفض جميع ملفات تعريف الارتباط أو للإشارة إلى وقت إرسال ملف تعريف الارتباط. ومع ذلك ، إذا كنت لا تقبل ملفات تعريف الارتباط ، فقد لا تتمكن من استخدام بعض أجزاء الخدمة. ما لم تقم بتعديل إعدادات المتصفح بحيث يرفض ملفات تعريف الارتباط ، فقد تستخدم الخدمة ملفات تعريف الارتباط.</p><p>ملفات تعريف الارتباط الفلاش. قد تستخدم بعض ميزات الخدمة المقدمة كائنات محلية مخزنة (أو ملفات تعريف ارتباط Flash) لجمع وتخزين معلومات حول تفضيلاتك أو نشاطك على الخدمة. لا تتم إدارة ملفات تعريف ارتباط الفلاش بواسطة نفس إعدادات المتصفح مثل تلك المستخدمة لملفات تعريف الارتباط الخاصة بالمتصفح.</p><p>إشارات الويب. قد تحتوي أقسام معينة من الخدمة ورسائل البريد الإلكتروني التي سنرسلها على ملفات إلكترونية صغيرة تُعرف باسم إشارات الويب (يشار إليها أيضًا باسم gifs الواضحة وعلامات البكسل وصور gif أحادية البكسل) التي تسمح لـ برامج تعليمي ، على سبيل المثال ، بإحصاء المستخدمين الذين زاروا تلك الصفحات أو فتحت بريدًا إلكترونيًا ولإحصائيات التطبيق الأخرى ذات الصلة (على سبيل المثال ، تسجيل شعبية قسم معين والتحقق من سلامة النظام والخادم).</p><p> يمكن أن تكون ملفات تعريف الارتباط "ثابتة" أو "جلسة". تظل ملفات تعريف الارتباط الدائمة على جهاز الكمبيوتر الشخصي أو الجهاز المحمول الخاص بك عندما تكون غير متصل بالإنترنت ، بينما يتم حذف ملفات تعريف ارتباط الجلسة بمجرد إغلاق التطبيق الخاص بك. تستخدم برامج تعليمي كلاً من ملفات تعريف الارتباط الخاصة بالجلسة وملفات تعريف الارتباط الدائمة للأغراض الموضحة أدناه: </p><p> ملفات تعريف الارتباط الضرورية / الأساسية </p><p> النوع: ملفات تعريف ارتباط الجلسة </p><p> بإدارة: التطبيق </p><p> الغرض: ملفات تعريف الارتباط هذه ضرورية لتزويدك بالخدمات المتاحة من خلال التطبيق ولتمكينك من استخدام بعض ميزاته. إنها تساعد في مصادقة المستخدمين ومنع الاستخدام الاحتيالي لحسابات المستخدمين. بدون ملفات تعريف الارتباط هذه ، لا يمكن توفير الخدمات التي طلبتها ، ونحن نستخدم ملفات تعريف الارتباط هذه فقط لتزويدك بهذه الخدمات. </p><p> سياسة ملفات تعريف الارتباط / ملفات تعريف الارتباط بقبول الإشعار </p><p> سياسة ملفات تعريف الارتباط / ملفات تعريف الارتباط بقبول الإشعار </p><p> بإدارة: التطبيق </p><p> الغرض: تحدد ملفات تعريف الارتباط هذه ما إذا كان المستخدمون قد وافقوا على استخدام ملفات تعريف الارتباط في التطبيق. </p><p> ملفات تعريف الارتباط الوظيفية </p><p> النوع: ملفات تعريف الارتباط الدائمة </p><p> بإدارة: التطبيق </p><p>  </p>';

                document.getElementById('h21').innerText = '21. استخدام بياناتك الشخصية:';
                document.getElementById('p21').innerHTML = '<p> يجوز لـ"مالك تعليمي" استخدام البيانات الشخصية للأغراض التالية: </p> <p> يجوز لـ"مالك تعليمي" استخدام البيانات الشخصية للأغراض التالية: </p> <p> لإدارة حسابك: لإدارة تسجيلك كمستخدم للخدمة. يمكن أن تمنحك البيانات الشخصية التي تقدمها إمكانية الوصول إلى الوظائف المختلفة للخدمة المتاحة لك كمستخدم مسجل. </p> <p> لأداء الاشتراك: التطوير والامتثال والتعهد باشتراك الشراء للخدمة (الخدمات) التي اشتريتها أو أي اشتراك آخر مع "مالك تعليمي" من خلال الخدمة. </p> <p> للاتصال بك: للاتصال بك عن طريق البريد الإلكتروني أو المكالمات الهاتفية أو الرسائل النصية القصيرة أو غيرها من أشكال الاتصالات الإلكترونية المماثلة ، مثل الإخطارات الفورية لتطبيقات الهاتف المحمول فيما يتعلق بالتحديثات أو الاتصالات الإعلامية المتعلقة بالوظائف والخدمات ، بما في ذلك التحديثات الأمنية ، عند الضرورة  أو الإعتيادية لتنفيذها. </p> <p> لتزويدك بالأخبار والعروض الخاصة والمعلومات العامة حول الخدمات الأخرى والحزم الخاصة التي نقدمها والتي تشبه تلك التي اشتريتها بالفعل أو استفسرت عنها ما لم تكن قد اخترت عدم تلقي هذه المعلومات. </p> <p> لإدارة طلباتك: لحضور وإدارة طلباتك إلينا. </p> <p> بالنسبة لعمليات نقل الأعمال: قد نستخدم معلوماتك لتقييم أو إجراء عملية اندماج أو تجريد أو إعادة هيكلة أو إعادة تنظيم أو حل أو بيع أو نقل آخر لبعض أو كل أصولنا ، سواء كان ذلك كمنشأة مستمرة أو كجزء من الإفلاس أو التصفية ، أو إجراء مشابه ، حيث تكون البيانات الشخصية التي نحتفظ بها حول مستخدمي الخدمة من بين الأصول المنقولة. </p> <p> لأغراض أخرى: قد نستخدم معلوماتك لأغراض أخرى ، مثل تحليل البيانات ، وتحديد اتجاهات الاستخدام ، وتحديد فعالية حملاتنا الترويجية ولتقييم وتحسين الخدمة (الخدمات) والتسويق وتجربتك. </p> <p> قد نشارك معلوماتك الشخصية في المواقف التالية: </p> <p> مع مزودي الخدمة: قد نشارك معلوماتك الشخصية مع مزودي الخدمة لمراقبة وتحليل استخدام الخدمة المقدمة ، للاتصال بك. </p> <p> بالنسبة لعمليات نقل الأعمال: يجوز لنا مشاركة معلوماتك الشخصية أو نقلها فيما يتعلق أو أثناء المفاوضات بشأن أي دمج أو بيع أصول الشركة أو التمويل أو الاستحواذ على كل أو جزء من أعمال "مالك تعليمي" إلى شركة أخرى. </p> <p> مع الشركات التابعة: قد نشارك معلوماتك مع الشركات التابعة لـ "مالك تعليمي" ، وفي هذه الحالة سنطلب من تلك الشركات التابعة احترام سياسة الخصوصية هذه. تشمل الشركات التابعة الشركة الأم لـ "مالك تعليمي" وأي شركات فرعية أخرى أو شركاء مشروع مشترك أو شركات أخرى نسيطر عليها أو تخضع لسيطرة مشتركة مع "مالك تعليمي". </p> <p> مع شركاء الأعمال: قد نشارك معلوماتك مع شركاء الأعمال في "مالك تعليمي" لنقدم لك خدمات أو عروض ترويجية معينة. </p> <p> مع مستخدمين آخرين: عندما تشارك معلومات شخصية أو تتفاعل بطريقة أخرى في المناطق العامة مع مستخدمين آخرين ، فقد يتم عرض هذه المعلومات من قبل جميع المستخدمين ويمكن توزيعها علنًا في الخارج. </p> <p> بموافقتك: يجوز لنا الكشف عن معلوماتك الشخصية لأي غرض آخر بموافقتك. </p>';

                document.getElementById('h22').innerText = '22. الاحتفاظ ببياناتك الشخصية:';
                document.getElementById('p22').innerHTML = '<p> ستحتفظ "مالك تعليمي" ببياناتك الشخصية فقط طالما كان ذلك ضروريًا للأغراض المنصوص عليها في سياسة الخصوصية هذه. سنحتفظ ببياناتك الشخصية ونستخدمها بالقدر اللازم للامتثال لالتزاماتنا القانونية (على سبيل المثال ، إذا كنا مطالبين بالاحتفاظ ببياناتك للامتثال للقوانين المعمول بها) ، وحل النزاعات ، وفرض اتفاقياتنا وسياساتنا القانونية. </p> <p> ستحتفظ "مالك تعليمي" أيضًا ببيانات الاستخدام لأغراض التحليل الداخلي. يتم الاحتفاظ ببيانات الاستخدام عمومًا لفترة زمنية أقصر ، إلا في حالة استخدام هذه البيانات لتعزيز الأمان أو لتحسين وظائف الخدمة المقدمة ، أو نحن ملزمون قانونًا بالاحتفاظ بهذه البيانات لفترات زمنية أطول. </p>';

                document.getElementById('h23').innerText = '23. نقل بياناتك الشخصية:';
                document.getElementById('p23').innerHTML = '<p> تتم معالجة معلوماتك ، بما في ذلك البيانات الشخصية ، في مكاتب تشغيل "مالك تعليمي" وفي أي أماكن أخرى توجد بها الأطراف المشاركة في المعالجة. وهذا يعني أنه يمكن نقل هذه المعلومات - والاحتفاظ بها - على أجهزة كمبيوتر موجودة خارج مملكة البحرين ، حيث قد تختلف قوانين حماية البيانات عن تلك الموجودة في الاختصاص القضائي في البحرين. </p> <p> موافقتك على سياسة الخصوصية هذه متبوعة بتقديمك لهذه المعلومات تمثل موافقتك على هذا النقل. </p> <p> ستتخذ "مالك تعليمي" جميع الخطوات اللازمة بشكل معقول لضمان التعامل مع بياناتك بشكل آمن ووفقًا لسياسة الخصوصية هذه ولن يتم نقل بياناتك الشخصية إلى منظمة أو دولة ما لم تكن هناك ضوابط كافية في مكانها بما في ذلك أمنك البيانات والمعلومات الشخصية الأخرى. </p>';

                document.getElementById('h24').innerText = '24. الكشف عن بياناتك الشخصية:';
                document.getElementById('p24').innerHTML = '<p> المعاملات التجارية. إذا كانت "مالك تعليمي" منخرطة في عملية دمج أو استحواذ أو بيع أصول ، فقد يتم نقل بياناتك الشخصية. سنقدم إشعارًا قبل نقل بياناتك الشخصية وإخضاعها لسياسة خصوصية مختلفة. </p> <p> تطبيق القانون. في ظل ظروف معينة ، قد يُطلب من "مالك تعليمي" الكشف عن بياناتك الشخصية إذا طُلب منها ذلك بموجب القانون أو استجابة لطلبات صحيحة من قبل السلطات العامة (مثل محكمة أو وكالة حكومية). </p> <p> المتطلبات القانونية الأخرى. قد تكشف "مالك تعليمي" عن بياناتك الشخصية بحسن نية، إن مثل هذا الإجراء ضروري من أجل: </p> <p> الامتثال لالتزام قانوني ؛ </p> <p> الحماية والدفاع عن حقوق أو ممتلكات "مالك تعليمي" ؛ </p> <p> منع المخالفات المحتملة المتعلقة بالخدمة أو التحقيق فيها ؛ </p> <p> حماية السلامة الشخصية لمستخدمي الخدمة أو الجمهور ؛ و </p> <p> الحماية من المسؤولية القانونية </p>';

                document.getElementById('h25').innerText = '25. تأمين بياناتك الشخصية:';
                document.getElementById('p25').innerText = 'تعتبر ضمانات بياناتك الشخصية مهمة بالنسبة لنا ، ولكن تذكر أنه لا توجد وسيلة نقل عبر الإنترنت أو طريقة تخزين إلكتروني آمنة بنسبة 100٪. بينما تسعى "مالك تعليمي" جاهدة لاستخدام وسائل مقبولة تجاريًا لحماية بياناتك الشخصية ، لا تستطيع "مالك تعليمي" ضمان أمنها المطلق.';

                document.getElementById('h26').innerText = '26. خصوصية الأطفال:';
                document.getElementById('p26').innerHTML = '<p> لا تتعامل خدمات "مالك تعليمي" مع أي شخص يقل عمره عن 13 عامًا. لا تجمع "مالك تعليمي" عن قصد معلومات تعريف شخصية من أي شخص دون سن 13 عامًا. إذا كنت أحد الوالدين أو الوصي وتدرك أن طفلك قد زودنا ببيانات شخصية ، من فضلك اتصل بنا. إذا علمت "مالك تعليمي" أنها جمعت بيانات شخصية من أي شخص يقل عمره عن 13 عامًا دون التحقق من موافقة الوالدين ، تتخذ "مالك تعليمي" خطوات لإزالة هذه المعلومات من خوادمها. </p> <p> إذا احتاجت "مالك تعليمي" إلى الاعتماد على الموافقة كأساس قانوني لمعالجة معلوماتك وكان بلدك يتطلب موافقة أحد الوالدين ، فقد تطلب "مالك تعليمي" موافقة والديك قبل جمع واستخدم تلك المعلومات. </p>';

                document.getElementById('h27').innerText = '27. روابط للتطبيقات الأخرى:';
                document.getElementById('p27').innerHTML = '<p> قد تحتوي خدمات برامج تعليمي على روابط لتطبيقات أخرى لا يتم تشغيلها بواسطة "مالك تعليمي". إذا قمت بالنقر فوق ارتباط جهة خارجية ، فسيتم توجيهك إلى تطبيق الطرف الثالث. ننصحك بشدة بمراجعة سياسة الخصوصية لكل تطبيق تزوره. </p> <p> ليس لدينا أي سيطرة ولا نتحمل أي مسؤولية عن المحتوى أو سياسات الخصوصية أو الممارسات الخاصة بأي تطبيق أو خدمات خاصة بطرف ثالث. </p>';

                document.getElementById('h28').innerText = '28. اتصل بنا:';
                document.getElementById('p28').innerText = 'إذا كان لديك أي أسئلة حول سياسة الخصوصية هذه ، يمكنك الاتصال بنا عن طريق زيارة هذه الصفحة على موقعنا على الإنترنت: www.taalimibahrain.com';
