                    ...
                    <li>
                        ...
                        <a href="#" class="dropdown-toggle tt" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            ...
                            <script>
                                ...
                                // var url = "//localhost/talimi_code/ar/" + pageName;
                            </script>

                            <a href="//localhost/talimi_code/ar/" onclick="location.href=this.href+pageName;return false;"><em class="hdtext" id="arbTranslate" style="float:right; color:white; display:block;">عربى</em></a>


                            <!-- <em class="hdtext " id="engTranslate" style="float:right; color:white; display:none;" onclick="location.href='talimi_code/ar'">Eng</em> -->
