...
// $config['base_url'] = 'http://216.10.241.16/taleemibeharain/';
$config['base_url'] = 'http://localhost/talimi_code/';
// $config['base_url'] = '';
...
| Typically this will be your index.php file, unless you've renamed it to something else. If you are using mod_rewrite to remove the page set this
